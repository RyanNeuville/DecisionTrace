...
* **Frontend**: React.js with TypeScript (Intuitive and modern interface).

* **User Interface Components**: Shadcn/ui and Tailwind CSS.

* **Backend**: Node.js with Express.

* **Database**: SQLite with secure user IDs (UUIDs).